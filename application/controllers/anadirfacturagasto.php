...
class Anadirfacturagasto extends CI_Controller {
    ...
    //No hace falta en todo caso controlar que losnumeros de las facturas del mismo proveedor bo sea igual
    public function numero_check($numero) {
        if($numero==null){
            ...
            if($numero==null){
                ...
                //dos facturas de un proveedor cuyo numero sea igual, ademas ponemos idcliente nulo porque
                //es una factura de gasto por lo tanto no tiene cliente
                return TRUE;
            }
            else{
