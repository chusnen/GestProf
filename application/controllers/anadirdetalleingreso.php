...
class Anadirdetalleingreso extends CI_Controller {
    ...
    function index(){
        ...
        if(is_null($usuarioAutentificado)){
            ...
            if(isset($_POST['anadir']))
                ...
                $this->form_validation->set_rules('preciounitario', 'preciounitario', 'required|xss_clean|max_length[13]|numeric');
    ...
    public function enviar(){
        ...
        if(is_null($usuarioAutentificado)){
            ...
            //Añado los totales en la tabla factura una vez que he añadido todo los detalles
            ...
            //Volcamos los datos en la base de datos y limpiamos la caché
            $this->doctrine->em->flush();
             //Muestro las facturas de ingresos que son las que el valor del proveedor es null
